...
export default function Dashboard() {
    ...
    const cashBalance = Number(
        portfolio?.cashBalance || 1000000.00
    );

    const netWorth = Number(
        portfolio?.netWorth || currentValue + cashBalance
    );
        ...
        return (
            <div className="page">
                ...
                >
                    ...
                    <p style={{ opacity: 0.6 }}>
                        Fetching portfolio, virtual wallet and AI insights
                    </p>
      ...
      ============================================ */}
            ...
            <div className="hero-grid">
                ...
                <div className="hero-card">
                    ...
                    <div className="hero-copy" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
                <span className="eyebrow">
                  TOTAL NET WORTH (STOCKS + CASH)
                </span>
                    ...
                    {profitLoss >= 0 ? "+" : ""}
                      ...
                      {profitPercent.toFixed(2)}%
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: "11px", opacity: 0.6, display: "flex", alignItems: "center", gap: "5px", justifyContent: "flex-end" }}>
                                <Wallet size={13} /> VIRTUAL CASH
                            </div>
